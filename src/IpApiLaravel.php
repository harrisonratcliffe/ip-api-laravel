...
class IpApiLaravel
{
    ...
    /**
     * IpApiLaravel constructor.
     *
     * @throws Exception If the given IP address is invalid or reserved.
     */
    protected function __construct(protected string $ip, int $timeout = 5)
    {
        $this->validateIp();
    ...
    /**
     * Create a new instance of the IpApiLaravel class with default settings.
     *
     * @throws Exception If the given IP address is invalid or reserved.
     */
    public static function default(string $ip, int $timeout = 5): self
    {
        return new static($ip, $timeout);
    }
